...
/// \brief This function is used by common::addFindFileURICallback to
...
std::string FindResourceUri(const common::URI &_uri)
{
  ...
  return findFileCb(common::copyFromUnixPath(suffix));
}
